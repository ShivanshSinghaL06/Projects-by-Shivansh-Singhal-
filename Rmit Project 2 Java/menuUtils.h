...
void printSolveMazeMenu(bool enhanced){
    std::cout << std::endl;
    ...
    std::cout << "3) Back" << std::endl;
    if (enhanced) {
        std::cout << "4) Show Shortest Escape Route" << std::endl;
    }
    std::cout << std::endl;
    std::cout << "Enter Menu item to continue: " << std::endl;
}
...
void printTeamInfo(void){
    ...
    //OUR TEAM **********
    std::cout << "\t [1] Shivansh Singhal (S3957577@rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Benjamin Hatfield (s3980858@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Adem Akbay (s4013156@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Ashton Bradley (s4003184@student.rmit.edu.au)" << std::endl;
    //AKA The Broad Beans *************
    std::cout << std::endl;
}
